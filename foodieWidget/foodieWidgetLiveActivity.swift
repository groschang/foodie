//
//  foodieWidgetLiveActivity.swift
//  foodieWidget
//
...
struct foodieWidgetAttributes: ActivityAttributes {
...
struct foodieWidgetLiveActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: foodieWidgetAttributes.self) { context in
