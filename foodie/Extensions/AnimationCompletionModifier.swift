...
struct AnimationCompletionModifier<Value>: @MainActor AnimatableModifier where Value: VectorArithmetic {
...
extension View {
    ...
    ) -> ModifiedContent<Self, AnimationCompletionModifier<Value>> {
