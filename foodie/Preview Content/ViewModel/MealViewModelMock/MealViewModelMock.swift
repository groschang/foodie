...
//
//    init(category: MealCategory = .stub, service: MealsClosureServiceType = MealsServicePreview()) {
...
//
//    override init(category: MealCategory = .stub, service: MealsClosureServiceType = MealsServicePreview(delay: true)) {
