...
//
//    init(category: Category = .stub, service: MealsClosureServiceType = MealsServicePreview()) {
...
//
//    override init(category: Category = .stub, service: MealsClosureServiceType = MealsServicePreview(delay: true)) {
